![docker image](https://github.com/ahm531/ahm531-oasis/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/ahm531/ahm531-oasis.git
    cd ahm531-oasis
    ```
    ...
    ```sh
    curl-L -o ahm531-oasis.zip "https://github.com/ahm531/ahm531-oasis/archive/main.zip"
    unzip ahm531-oasis.zip
    cd ahm531-oasis
    ```
...
your `docker-compose.yaml` with `ghcr.io/ahm531/ahm531-oasis:main` for the services
...
```
docker pull ghcr.io/ahm531/ahm531-oasis/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/ahm531/ahm531-oasis/manifests/main": unauthorized`
